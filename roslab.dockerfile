...
RUN git clone https://github.com/HJReachability/crazyflie_clean.git /crazyflie_clean \
 && cd /crazyflie_clean \
 && mkdir -p ${HOME}/catkin_ws/src \
 && cp -R /crazyflie_clean ${HOME}/catkin_ws/src/. \
 && cd ${HOME}/catkin_ws \
 ...
 && rm -fr /crazyflie_clean

##################################### COPY #####################################

RUN mkdir ${HOME}/meta-fastrack

COPY . ${HOME}/meta-fastrack

#################################### CATKIN ####################################

RUN mkdir -p ${HOME}/catkin_ws/src && ln -s ${HOME}/meta-fastrack ${HOME}/catkin_ws/src/.
